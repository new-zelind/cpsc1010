...
int main()
{
	...
	double taxState = 0.014;
	double taxFica = 0.06201;
	double taxMedicare = 0.0145;
	double taxTotal;

	//Ask the user how many hours they worked during the week, and store that
	//number into the variable userHours; do the same with wage, instead with 
	//variable userWage.
